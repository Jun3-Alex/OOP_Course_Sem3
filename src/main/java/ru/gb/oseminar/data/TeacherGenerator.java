...
public class TeacherGenerator extends StudentGenerator {
    ...
    public static Teacher generateRandomTeacher() {
        ...
        Long teacherId = (long) random.nextInt(1000); // Просто случайное число в качестве ID

        return new Teacher(firstName, secondName, patronymic, dateOfBirth, teacherId);
    }
